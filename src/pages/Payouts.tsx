...
import PayoutInitiation from "@/components/payouts/PayoutInitiation";
        ...
        <div className="flex-1 overflow-auto">
          <header className="sticky top-0 z-30 bg-white border-b px-4 sm:px-6 py-3 flex items-center justify-between">
            <div className="flex items-center">
              <SidebarTrigger />
              <div className="ml-4 text-lg font-medium">Payouts</div>
            </div>
          ...
          <main className="px-4 sm:px-6 py-6 bg-gray-50">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">Initiate, track, and manage payouts to vendors, utility companies, and partners.</p>
            </div>
