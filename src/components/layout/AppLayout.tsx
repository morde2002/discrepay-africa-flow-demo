    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="relative flex h-full w-full max-w-xs flex-1 flex-col bg-white pt-5 pb-4">
          ...
          <div className="flex flex-shrink-0 items-center px-4">
            <h1 className="text-2xl font-bold text-insura-600">Insura</h1>
          </div>
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center rounded-md px-2 py-2 text-base font-medium ${
                      isActive
                        ? 'bg-insura-50 text-insura-600'
                        : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                    }`}
                  >
                    <item.icon
                      className={`mr-4 h-6 w-6 flex-shrink-0 ${
                        isActive ? 'text-insura-600' : 'text-gray-400 group-hover:text-gray-500'
                      }`}
                      aria-hidden="true"
                    />
                    {item.name}
      ...
      <div className="flex flex-1 flex-col lg:pl-64">
        <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 border-b border-gray-200 bg-white">
          <button
            type="button"
            className="border-r border-gray-200 px-4 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-insura-500 lg:hidden"
            onClick={toggleSidebar}
          >
                ...
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                    <Avatar className="h-8 w-8">
                      <AvatarFallback className="bg-insura-100 text-insura-800">MM</AvatarFallback>
                    </Avatar>
                  </Button>
                </DropdownMenuTrigger>
